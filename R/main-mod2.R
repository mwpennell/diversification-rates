## Re-write of the modified to improve parrallelization
...
fit_vrm_est_ci <- function(i, tree_info, grid_size){
...
parallel::mclapply(c(1:nrow(tree_info)),
                   function(x) fit_vrm_est_ci(x, tree_info, grid_size),
                   mc.cores = ncores - 2)
